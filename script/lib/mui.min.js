...
var mui = function (a, b) {
    ...
    i.uuid = 0, i.data = {}, i.extend = function () {
        ...
        var c, d, e, f = [];
        if ("number" == typeof a.length)for (d = 0, len = a.length; d < len; d++)c = b(a[d], d), null != c && f.push(c); else for (e in a)c = b(a[e], e), null != c && f.push(c);
...
!function (a, b) {
    ...
    a.EVENT_START = "touchstart", a.EVENT_MOVE = "touchmove", a.EVENT_END = "touchend", a.EVENT_CANCEL = "touchcancel", a.EVENT_CLICK = "click", a.gestures = {session: {}}, a.preventDefault = function (a) {
        a.preventDefault()
    ...
    a.os.plus && a.os.android && a.addBack({
        ...
        if (c)a.trigger(c, "touchstart"), a.trigger(c, "tap"); else if (b.plus) {
    ...
    var d = "mui-pull-top-pocket", e = "mui-pull-bottom-pocket", f = "mui-pull", g = "mui-pull-loading", h = "mui-pull-caption", i = "mui-pull-caption-down", j = "mui-pull-caption-refresh", k = "mui-pull-caption-nomore", l = "mui-icon", m = "mui-spinner", n = "mui-icon-pulldown", o = "mui-block", p = "mui-hidden", q = "mui-visibility", r = g + " " + l + " " + n, s = g + " " + l + " " + n, t = g + " " + l + " " + m, u = ['<div class="' + f + '">', '<div class="{icon}"></div>', '<div class="' + h + '">{contentrefresh}</div>', "</div>"].join(""), v = {
        init: function (b, c) {
            this._super(b, a.extend(!0, {
                ...
                indicators: !0,
                deceleration: .003,
                down: {height: 50, contentdown: "下拉可以刷新", contentover: "释放立即刷新", contentrefresh: "正在刷新..."},
                up: {
                    height: 50,
                    auto: !1,
                    contentdown: "上拉显示更多",
    ...
    var c = "mui-slider", d = "mui-slider-group", e = "mui-slider-loop", f = "mui-slider-indicator", g = "mui-action-previous", h = "mui-action-next", i = "mui-slider-item", j = "mui-active", k = "." + i, l = "." + f, m = ".mui-slider-progress-bar", n = a.Slider = a.Scroll.extend({
        init: function (b, c) {
            ...
            if (b.target === c.wrapper) {
                ...
                if (c.loop && (f += 1), !c.wrapper.classList.contains("mui-segmented-control"))for (var g = 0, h = e.length; h > g; g++) {
                    var i = e[g];
                ...
                if (l) {
                    ...
                    if (m.length > 0)for (var g = 0, h = m.length; h > g; g++)m[g].classList[g === d.slideNumber ? "add" : "remove"](j); else {
                        var n = l.querySelector(".mui-number span");
                        if (n)n.innerText = d.slideNumber + 1; else for (var o = c.wrapper.querySelectorAll(".mui-control-item"), g = 0, h = o.length; h > g; g++)o[g].classList[g === d.slideNumber ? "add" : "remove"](j)
                    }
                }
                b.stopPropagation()
            }
    ...
    var f = "mui-control-item", g = "mui-segmented-control", h = "mui-control-content", i = "mui-bar-tab", j = "mui-tab-item", k = function (a, b) {
        return b.classList && (b.classList.contains(f) || b.classList.contains(j)) ? (a.preventDefault(), b) : !1
    };
    a.registerTarget({name: d, index: 80, handle: k, target: !1}), b.addEventListener("tap", function (b) {
        var e = a.targets.tab;
        if (e) {
    ...
    k.prototype.init = function () {
        ...
        b.contains(f) ? (b.remove(f), this.handle.style.webkitTransform = "translate(0,0)") : (b.add(f), this.handle.style.webkitTransform = "translate(" + this.handleX + "px,0)"), a.trigger(this.element, "toggle", {isActive: this.classList.contains(f)})
    ...
    a.confirm = function (c, d, e, f) {
        if (a.os.plus) {
            if (void 0 === typeof c)return;
            "function" == typeof d ? (f = d, d = null, e = null) : "function" == typeof e && (f = e,
                e = null), a.plusReady(function () {
    ...
    r.prototype.init = function () {
        ...
        return this.each(function () {
            ...
            if (g)b = a.data[g]; else {
                g = ++a.uuid, b = a.data[g] = new r(this, {actions: d.join(",")});
